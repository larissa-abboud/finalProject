...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2443925265ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oddjobberdb&table=currently_loged_in">`oddjobberdb`.`currently_loged_in`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oddjobberdb&table=saved">`oddjobberdb`.`saved`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oddjobberdb&table=user">`oddjobberdb`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oddjobberdb&table=book_app">`oddjobberdb`.`book_app`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oddjobberdb&table=post">`oddjobberdb`.`post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pracdb&table=posts">`pracdb`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pracdb&table=user">`pracdb`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pracdb&table=title">`pracdb`.`title`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=practicedb&table=user">`practicedb`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=practicedb&table=userinfo">`practicedb`.`userinfo`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="767a644d7072625d70532b576432747d">
